<template>
    <ul class="timeline">
        <li v-for="(timeline, index) in timelines" data-aos="zoom-in-up" data-aos-duration="200" :data-aos-delay="100 * index" data-aos-anchor-placement="center-bottom">
    ...
    data() {
        return {
            timelines: [
                ...
                {
                    title: 'First Runner Up, PLM Leadership Training',
                    date: '2019',
